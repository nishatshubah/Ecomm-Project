      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] && $_SESSION['role'] == "2") { ?>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="admin_db/index.php">Dashboard</a></li>
              <li><a class="dropdown-item" href="admin_db/category.php">Category</a></li>
              <li><a class="dropdown-item" href="admin_db/products.php">Product</a></li>
              <li><a class="dropdown-item" href="admin_db/order.php">Orders</a></li>
            </ul>
          </li>
        <?php } ?>
        <li class="nav-item">
          <a class="nav-link position-relative" href="cart.php"><i class="bi bi-basket-fill"></i><span id="cartLenght"
