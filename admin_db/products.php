                ...
                <div class="Tablecontainer" id="tablecontent">
                    <table class="table" style="border: 1px; width: 100%; margin:0; padding: 0;">
                        ...
                        <tbody>
                            ...
                            //     <td><a href='product/edit.php?id={$row['id']}'><i class='bi bi-pencil-square'></i></a> | <a onclick=\"return confirm('Are you sure want to delete this?');\" href='product/delete.php?id={$row['id']}'><i class='bi bi-trash'></i></a></td>
                            // </tr>";
                            // }
                            ?>
                        </tbody>
