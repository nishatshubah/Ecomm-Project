...
<?php include("inc/nav.php"); ?>
    ...
    <div id="layoutSidenav">
        ...
        <form action="subcategory/addsubcat.php" method="post" enctype="multipart/form-data">
            <h3>SUBCATEGORY</h3>
           ...
           <textarea name="description" id="description" cols="30" rows="3" placeholder="discription..."></textarea>

            <input type="submit" name="addsubcategory" value="Add Sub Category" class="form-btn">
