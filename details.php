    ...
    <div class="container">
            ...
            <div class="card details-card p-0">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <img class="card-img-top img-fluid details-img" src="assets/products/<?= $d['images'] ?>" alt="">
                    </div>
                    <div class="col-md-6 col-sm-12 description-container p-5">
                        <div class="main-description">
                            ...
                            <hr>
                            <p class="pprice product-price">
                                <?= $d['price'] ?>
                            </p>
                            <form class="add-inputs" method="post">
                                <input type="number" class="form-control" id="cart_quantity" name="cart_quantity"
                                    value="1" min="1" max="10">
                                <button name="add_to_cart" type="submit" class="addToCart btn btn-primary btn-lg" data-id=<?= $d['id'] ?>>Add to cart</button>
                            </form>
                            <form class="add-inputs" method="post">
      ...
      $(document).ready(function () {
        ...
        $(".addToCart").click(function () {
          ...
          let image = $t.parent().parent().parent().parent().find(".card-img-top").attr("src");
